...
export const DEFAULT_PRICES: PriceData = {
  ...
  source: 'Displaying Initial Market Estimates'
};
...
// Centralized Ad Slot Management - STRATEGY: Ads ONLY on high-value guide pages for approval.
export const AD_SLOTS = {
  GUIDE_ARTICLE_CONTENT: '8923481234', // Ad for inside guide articles
};
